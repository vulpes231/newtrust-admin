    ...
    <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
      ...
      <div className="overflow-x-auto">
        <table className="w-full border-collapse">
          {/* Table Header */}
          <thead className="bg-[#5156be] !text-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
            <tr>
              {headers.map((hd) => (
                <th
                  key={hd.id}
                  className="px-6 py-4 text-left text-xs font-semibol uppercase tracking-wider"
                >
                  {hd.title}
                </th>
              ))}
              <th className="px-6 py-4 text-left text-xs font-semibol uppercase tracking-wider">
                Actions
              </th>
            </tr>
          </thead>
