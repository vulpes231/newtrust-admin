...
const Closetrade = ({ tradeId, onClose }) => {
	const [error, setError] = useState("");
	const dispatch = useDispatch();

	const { closePositionLoading, closePositionError, positionClosed } =
	...
	useEffect(() => {
		if (closePositionError) {
			setError(closePositionError.message);
		}
	}, [closePositionError]);
